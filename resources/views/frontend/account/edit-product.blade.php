...
<div class="col-sm-9">
    <div class="blog-post-area">
        ...
        <div class="signup-form"><!--sign up form-->
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('account.updateProduct')}}" class="form-horizontal form-material mx-2" enctype="multipart/form-data"   method="POST">
                    @csrf
                    @if(!empty($dataProduct))
                        @php
                            $decodedImage = json_decode($dataProduct[0]->image);
                        @endphp
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="text" name="name" placeholder="Johnathan Doe" class="form-control form-control-line" value="{{old('name') ?? $dataProduct[0]->name}}">
                            </div>
                        </div>
                        @if($errors->has('name'))
                        <div class="alert alert-danger alert-dismissible">
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="text" name="price" placeholder="56" class="form-control form-control-line" value="{{old('price') ?? $dataProduct[0]->price }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <select class="form-select form-control-line" name="id_category">
                                    <option value="{{$dataProduct[0]->id_category}}" selected >{{$dataProduct[0]->category}}</option>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <select class="form-select shadow-none form-control-line" name="id_brand">
                                    <option value="{{$dataProduct[0]->id_brand}}" selected = "selected">{{$dataProduct[0]->brand}}</option>
                                    @if(!empty($listBrand))
                        ...
                        <div id="saleInput" class="form-group" style="display: none;">
                            <div class="col-md-3">
                                <input type="text" name="sale" placeholder="0" class="form-control form-control-line" value = {{$dataProduct[0]->sale}}>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <input type="file" name="image[]" class="form-control form-control-line" id="files" multiple accept="image/*" max="3" />
                            </div>
                        </div>
                        <div class="form-group">
                        @foreach($decodedImage as $image)
                            <div class="col-md-3">
                                <img  src="{{asset('uploads/product/'.$image) }}" alt="{{ $image }}"  width="80" >
                                <input name="delete_images[]" value="{{$image}}" type="checkbox" accept="image/*"/>
                            </div>
                        @endforeach
                        </div>
                        <div class="form-group">
